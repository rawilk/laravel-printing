...
use Rawilk\Printing\Tests\Fixtures\Drivers\Custom\Entity\Printer as CustomDriverPrinter;
...
final class CustomDriver implements Driver
{
    ...
    public function printers(?int $limit = null, ?int $offset = null, string|int|null $dir = null): Collection
    {
